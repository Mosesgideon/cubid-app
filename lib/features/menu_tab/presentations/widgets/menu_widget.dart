...
import 'package:social_media/features/menu_tab/presentations/widgets/viewpost.dart';
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            InkWell(
                                              onTap: () {
                                                Navigator.of(context).push(
                                                    CupertinoPageRoute(
                                                        builder: (
                                                            ctx) => UserProfileView(snapshot: null,)));
                                              },
                                              child: Text(
                                                snapshot.data?.docs[index]
                                                    .get('posterName'),
                                            ...
                                            Text(
                                              DateFormat.jmz().format(DateTime
